// Owning-source acceptance for Hub #218. No installed state or physical writer.
...
const identity=sessionId=>({provider:'codex',client:'desktop',hostId:'host',sourceId:'source',sessionId});
...
try{
 ...
 const packet={initial:envelope(initial),removed:envelope(removed),fresh:envelope(fresh),corpus};
 ...
 const report={hubRevision:execFileSync('git',['rev-parse','HEAD'],{encoding:'utf8'}).trim(),pixooRevision:pin.revision,nanoleafRevision:nanoPin.revision,
