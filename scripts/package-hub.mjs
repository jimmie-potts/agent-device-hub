...
try {
  ...
  for(const [name,archive] of [['agent-state','jimmie-potts-agent-state-3.1.0.tgz'],['device-contracts','jimmie-potts-device-contracts-1.0.0.tgz'],['device-mcp','jimmie-potts-device-mcp-1.0.0.tgz']]){
