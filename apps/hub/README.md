...
| Nanoleaf settings | `nanoleaf.integration/1.0`; owning-service check against source `0043456deea4f224dfa39ae1bb9d4f289e77e3d1` (`scripts/check-hub-nanoleaf.mjs`, including the geometry route); request consumer and fixtures vendored from `80628498136203a8f5fcb06ab5fa306e961e2def`, so the hub forwards only the four configuration commands and never `animation.play`; both recorded in `fixtures/nanoleaf-source.json` |
