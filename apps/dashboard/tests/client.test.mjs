...
try {
 ...
 test('status text says what happened and whether anything changed, never claiming a physical result',()=>{
  ...
  assert.deepEqual(resultMessage({outcome:'cancelled',priorEffects:'none'}),{message:'Already in effect. Nothing was sent.',locked:false,settled:'accepted'},'a same-mode command with nothing to reapply');
