...
GUIDES = [
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ['BUNNY system design documents', 'Completed [[H103]]', 'Hub PR #104 delivered the linked HTML atlas and offline references for 37 HTTP operations and 28 source-defined tables. Issue #103 is closed. Browser request controls remain disabled; documentation does not implement or deploy the described system.'],
