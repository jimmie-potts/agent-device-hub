...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['Current-status follow-up', '[[H137]]', 'The source candidate uses agent-state 2.0.0 and Hub 0.2.0 with unchanged version 1.0 snapshots/storage. Ordinary Codex starts/stops select active, idle and active again; new-turn notice clearing remains consumer-specific and attention stays independent. Tests cover old ambiguous-store recovery, bounded retirement, the packaged hook and both real consumer projections using disposable state. Previously unseen delayed starts can still select incorrectly or clear a notice prematurely. Final delivery and the installed Pixoo [[P34]] retest remain pending.'],
