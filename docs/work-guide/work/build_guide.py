...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['02 / Shared state and contracts', '[[H3]] [[P29]]', 'Pixoo #29 delivered adoption of the released lifecycle schema, fixtures and consumer requirements in PR #53. Hub #3 is in progress. Its source candidate supplies deterministic reduction, host storage persistence, retained notices, a bounded diagnostic journal, independent consumers and qualified source emitters. Pixoo #31 still owns production hosting and storage adoption.'],
