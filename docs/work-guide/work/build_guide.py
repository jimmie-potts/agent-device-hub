...
GUIDES = [
    ...
    dict(id='controls-music', short='Controls + music', title='Expand into general device controls and Apple Music', phase='After Codex acceptance',
         ...
         headers=['Stage', 'Issues', 'Work'], rows=[
             ...
             ['Pixoo controls', '[[H151]] → [[H154]]', 'Screen power, brightness, playlist selection and the six playback actions through the existing hub route; Pixoo already declares these in controller v1, so no wire change is needed. Human UI approval of the candidate is required. Physical acceptance on the display is [[H154]].'],
