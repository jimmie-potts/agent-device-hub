...
GUIDES = [
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Completed / Public work guide hosting', '[[H80]]', 'Hub #80 is closed after independent verification of the existing public edition: all nine served HTML hashes match source 950f7f6. Publishing newer guide revisions remains a separate action. This source guide update does not publish the website.'],
