...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['05 / Shared hosting and clients', '[[H5]] [[H8]] [[H6]] [[H13]]', 'Hub #5 now targets Linux in WSL; native Windows runtime qualification is outside its accepted scope. Its source candidate now verifies the delivered [[P33]] API, Nanoleaf settings, supervised migration and rollback after writes. Final independent review and CI remain pending. The owner approved 256 MiB service RSS; [[H123]] tracks later budget and memory improvements. Source delivery, reversible hook migration [[H8]], the common frontend and shared MCP discovery/status remain separate gates.'],
