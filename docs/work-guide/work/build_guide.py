...
GUIDES = [
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Guide cleanup and browser check', '[[H210]] → [[H207]]', 'Make denied and missing clipboard cases deterministic while retaining the granted-copy test. This work blocks the delivery cleanup follow-up.'],
             ['Shared cache and Node setup guidance', '[[N84]] [[P72]] [[H212]]', 'Update setup guidance to use the shared npm and Playwright caches and select Node 24 with fnm. Hub #212 follows the browser-check repair in [[H210]].'],
