...
GUIDES = [
    ...
    dict(id='controls-music', short='Controls + music', title='Expand into general device controls and Apple Music', phase='After Codex acceptance',
         ...
         headers=['Stage', 'Issues', 'Work'], rows=[
             ...
             ['Completed / Pixoo controls', '[[H151]]', 'Hub #151 closed as completed on September 22, 2026 after PR #160 merged as d91bee7 with independent Standards and Specification reviews, hosted checks and explicit human UI approval recorded on the PR. The Pixoo view offers screen power, brightness, saved-playlist selection and the six playback actions, one guarded controller v1 command each through the existing hub route, with Monitor gating and an explicit Media switch through the Pixoo integration mode operation because the real controller declares controller v1 modes unsupported. Nothing is installed or operated by the source merge.'],
             ['Pixoo display acceptance', '[[H154]]', 'Install and verify the Pixoo general controls on the physical display after the merged #151 source; source tests and transport receipts do not establish what the display shows.'],
...
<article><h3>Next decision</h3><p>Hub #32 and the general-control definition Hub #31 are closed. Choose between the Pixoo slice #151 and Pixoo #67, which have no open prerequisites; Nanoleaf #64 is delivered and the Nanoleaf view #153 no longer waits on it.</p><a href="#controls-music">Review general controls</a></article>
