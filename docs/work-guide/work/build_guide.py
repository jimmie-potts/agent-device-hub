...
GUIDES = [
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Guide workspace design and release', '[[H85]] → [[H86]] → [[H87]]', 'The phone-first Neon/Prism design and selected presentation are complete. Publish and verify the first combined mobile release. [[H87]] also requires delivered task briefs [[H196]] and current public status [[H197]]. Later functionality remains planned; this snapshot refresh does not deliver it.'],
             ...
             ['Guide cleanup and browser check', '[[H210]] → [[H207]]', 'The clipboard fallback repair is complete. The main-branch Work guide CI result remains the evidence gate for closing the cleanup follow-up.'],
             ['Shared cache and Node setup guidance', '[[N84]] [[P72]] [[H212]]', 'Update setup guidance to use the shared npm and Playwright caches and select Node 24 with fnm. Hub #212 follows the completed browser-check repair in [[H210]].'],
             ['Automatic public refresh', '[[H200]]', 'Hub #200 is closed; no automatic status publication scheduler is running.'],
