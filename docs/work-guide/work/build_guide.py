...
GUIDES = [
    ...
    dict(id='nanoleaf-presentation', short='Rendering + displays', title='Improve Nanoleaf rendering, customization, and persistent displays', phase='Independent experience',
         ...
         headers=['Group', 'Issues and order', 'Dependency or boundary'], rows=[
             ...
             ['Prism crystal artwork', '[[N52]] → [[N53]] → [[N26]]', 'Connector geometry merged in Nanoleaf PR #56 with passing main CI; #52 remains open for guide synchronization. Crystal artwork and two-second flow are in PR #58. Luminous numbering is in PR #60. Local checks, Windows CI evidence and independent reviews are recorded in those PRs; final validation, current UI approval and source delivery remain pending. Tray artwork and physical-light animation changes are excluded.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ['Bound CI costs and hangs', '[[N37]]; completed [[P46]]', 'Pixoo #46 merged through PR #57 with all five PR and main checks passing. Nanoleaf #37 source merged through PR #61 with all nine PR and main jobs passing; it remains open for separately owned guide companion PR #90. The original sequence limited CI churn; it was not a product dependency.'],
