...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['Completed / Pixoo integration controls', '[[P33]]', 'Pixoo #33 is closed after source PR #64 merged Monitor/Media controls and the protected integration API. The dedicated guide and architecture synchronization remains with <a href="https://github.com/jimmie-potts/agent-device-hub/pull/119" target="_blank" rel="noopener noreferrer">Hub PR #119</a>; this publication preserves the existing architecture review dates and pins. Dashboard renderer [[P32]] is delivered, while [[P34]] retains installed-client and physical acceptance.'],
