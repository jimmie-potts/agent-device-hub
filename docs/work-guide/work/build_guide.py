...
GUIDES = [
    ...
    dict(id='desktop-controls', short='Desktop controls', title='Add Wispr, Codex mouse actions and later desk presets', phase='Independent shortcuts, then shared presets',
         intro='[[H63]] is closed after documentation merged in PR #140. [[H64]] source qualification is in progress. Owner packaging identifies keyboard 85HA and N30 mouse 85CA; held input and app acceptance remain pending. The other seven issues are blocked by their prerequisites. <strong>Wispr and basic Codex mouse controls can ship without the hub, shared monitoring, general controls or Music.</strong> Wispr retains its own service requirements.',
         headers=['Work', 'Owning issue', 'Required prerequisites and result'], rows=[
             ...
             ['Hardware and Wispr qualification', '[[H64]]', 'No source prerequisites. The qualification report identifies the N Edition keyboard 85HA and N30 mouse 85CA. The N30 has an existing navigation D-pad; R8 custom-mapping claims do not apply. Actual inputs, Big A hold/release, focus, coexistence and restoration still need authorized evidence. [[H65]] remains blocked.'],
