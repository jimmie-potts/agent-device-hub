...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['04 / Consumers and integration controls', '[[P32]] [[P33]] [[N29]] [[N49]]', 'Nanoleaf #29 is in source implementation. Explicit shared selection makes the feed authoritative while the existing Python worker remains the sole light writer. Disconnected or uncertain sessions retain steady last colors, with no automatic legacy fallback. An evidenced new turn clears notices for Nanoleaf only. Installed cutover and physical acceptance remain with Hub #8 and Nanoleaf #30. Pixoo dashboard, Monitor/Media controls and protected settings/assignments retain their own work.'],
