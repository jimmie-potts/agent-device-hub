...
GUIDES = [
    ...
    dict(id='nanoleaf-presentation', short='Rendering + displays', title='Improve Nanoleaf rendering, customization, and persistent displays', phase='Independent experience',
         ...
         headers=['Group', 'Issues and order', 'Dependency or boundary'], rows=[
             ...
             ['Prism crystal artwork', '[[N52]] → [[N53]] → [[N26]]', 'Connector geometry and crystal artwork merged in Nanoleaf PRs #56 and #58, each with all nine main jobs passing. The user approved the integrated Prism UI. Luminous numbering merged in PR #60 after all nine PR jobs passed; its merged-main checks are pending at this snapshot. The full browser suite passed all 360 click cases and 720 label-clearance measurements after a mode-observation timing correction. All three issues remain open for final verification and guide synchronization. Tray artwork and physical-light animation changes are excluded.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Hub CI efficiency', '[[H91]]', 'PR #92 merged the core scheduling policy. Full delivery and measured savings remain pending; reconcile the guide workflow and any build optimization in its own delivery.'],
