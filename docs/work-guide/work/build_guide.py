...
GUIDES = [
    ...
    dict(id='nanoleaf-presentation', short='Rendering + displays', title='Improve Nanoleaf rendering, customization, and persistent displays', phase='Independent experience',
         ...
         headers=['Group', 'Issues and order', 'Dependency or boundary'], rows=[
             ...
             ['Prism crystal artwork', '[[N52]] → [[N53]] → [[N26]]', 'Connector geometry and crystal artwork merged in Nanoleaf PRs #56 and #58, each with all nine main jobs passing. The user approved the integrated Prism UI. Luminous numbering remains in PR #60 while its final checks run. Its browser suite passed all 360 click cases and 720 label-clearance measurements; a mode-observation timing correction is under renewed validation. Issues #52 and #53 remain open for guide synchronization. Tray artwork and physical-light animation changes are excluded.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Further CI savings', '[[H91]]', 'Evaluate additional CI savings while preserving test coverage. This newly recorded work remains unimplemented.'],
