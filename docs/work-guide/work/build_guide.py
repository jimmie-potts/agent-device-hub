...
GUIDES = [
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Guide workspace design and release', '[[H85]] → [[H86]] → [[H87]]', 'Design the phone-first Neon/Prism guide and atlas, apply the selected presentation, then publish and verify the first combined mobile release. [[H87]] also requires task briefs [[H196]] and current public status [[H197]]. The later functionality remains planned; this snapshot refresh does not deliver it.'],
             ['Mobile task briefs and status', '[[H196]] [[H197]]', 'Prepare copyable Explain, Plan, Implement and Review briefs for the existing Codex and Claude apps, and show current public GitHub status with explicit freshness. Both can start using the current styles; anonymous phone reading and manual handoff remain available.'],
             ['Automatic public refresh', '[[H200]]', 'After [[H197]] and the first public release [[H87]], activate automatic status publication under a reviewed publishing policy. No scheduler is running from this tracker definition.'],
