...
GUIDES = [
    ...
    dict(id='controls-music', short='Controls + music', title='Expand into general device controls and Apple Music', phase='After Codex acceptance',
         ...
         headers=['Stage', 'Issues', 'Work'], rows=[
             ...
             ['Nanoleaf controls', '[[H153]] → [[H155]]', 'Hub #153 adds the Nanoleaf view controls on the delivered #64 capabilities; scene controls stay disabled while the wall presents agent status, with the explicit Free switch. Physical acceptance on the installed wall is [[H155]].'],
