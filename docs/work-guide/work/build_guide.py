...
GUIDES = [
    ...
    dict(id='desktop-controls', short='Desktop controls', title='Add Wispr, Codex mouse actions and later desk presets', phase='Independent shortcuts, then shared presets',
         ...
         headers=['Work', 'Owning issue', 'Required prerequisites and result'], rows=[
             ...
             ['Hardware and Wispr qualification', '[[H64]]', 'Qualification is under review in Hub PR #143. The owner identified keyboard 85HA and N30 mouse 85CA, observed four distinct N30 browser outputs and an A Enter press/release. B produced a complete Ctrl+Win hold/release after the observer repeat cutoff was corrected. The owner passed the brief Wispr/Notepad trial and cleared both mappings. Receiver identity, persistence/recovery and selective mouse handling remain unresolved. Read the qualification report for evidence limits.'],
             ['Independent / Local controls', '[[H65]]', 'Requires [[H63]] and [[H64]]. Version 1 defaults: Big B holds Ctrl+Win for Wispr and releases to insert. Big A sends Enter only on a separate deliberate press. Both bindings must be editable, saved and restorable in version 1; [[H70]] does not gate A/B editing. Dictation release never automatically sends Enter. Codex mouse actions: next task needing attention, command menu, previous task and next task. Preserve ordinary mouse behavior outside Codex.'],
             ...
             ['Later / Custom mappings and profiles', '[[H70]]', 'Requires [[H65]]. Extend version 1 A/B editing to every hardware-exposed remappable control, saved profiles, supported app/hub actions and custom shortcuts. Local profile editing stays useful without optional preset or Music providers.'],
...
<article><h3>Next decision</h3><p>Hub #32, the general-control definition Hub #31 and the Pixoo controls slice Hub #151 are closed. The Nanoleaf view #153 is in progress; choose Pixoo #67 or Hub #152 as companions, and the display acceptance #154 waits on its installation permission.</p><a href="#controls-music">Review general controls</a></article>
