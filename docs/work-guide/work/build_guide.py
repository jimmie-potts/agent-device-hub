...
assert HISTORY['repositories']['agent-device-hub']['headSha'] == AD.SOURCES['sourceRevisions']['agent-device-hub']
assert HISTORY['repositories']['codex-nanoleaf']['headSha'] == AD.SOURCES['sourceRevisions']['codex-nanoleaf']
assert HISTORY['repositories']['divoom-app-upgrade']['headSha'] == AD.SOURCES['sourceRevisions']['divoom-app-upgrade']
METADATA = dict(refreshedAt=SNAPSHOT['refreshedAt'], staticSnapshot=True, openIssues=TOTAL,
                ...
                primaryCoverage=coverage, completedBaselines=['P26', 'H4', 'H7'],
