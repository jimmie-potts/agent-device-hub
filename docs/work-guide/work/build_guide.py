...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['04 / Consumers and integration controls', '[[P33]]', 'Pixoo dashboard [[P32]] is delivered through PR #63: exact RGB preview, stable pagination and bounded generation publication. Pixoo #33 has a source candidate for explicit Monitor/Media controls, selected views and a protected extension; merge and acceptance checks remain pending.'],
