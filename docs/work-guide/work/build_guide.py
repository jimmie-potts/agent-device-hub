...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['04 / Consumers and integration controls', '[[P32]] [[P33]] [[N49]]', 'Pixoo dashboard, Monitor/Media controls and protected settings/assignments retain their own work. Nanoleaf #49 is in source implementation with a Nanoleaf-owned versioned settings extension. Shared controller v1 stays unchanged; native Linux and retained Windows use their existing private state and single worker. Frontend integration remains separate.'],
