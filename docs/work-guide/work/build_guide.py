...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['06 / Integrated qualification and acceptance', '[[H30]] [[H9]] [[P34]] [[N30]]', 'Hub #30 qualifies the standalone Linux/WSL source with real consumers, synthetic events and fake device transports. Live installation and physical timing are not required for its closure. Pixoo #34 and Nanoleaf #30 separately own their reduced personal-project installation and device checks; Hub #9 consumes source qualification.'],
         ], notes=[
             ...
             '[[H30]] retains the early budget evidence as history. Its revised completion scope is bounded standalone Linux/WSL source qualification; embedded-host hardening [[P61]], personal installation and physical measurements do not block it.',
