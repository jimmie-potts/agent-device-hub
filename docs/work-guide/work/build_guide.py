...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ['01 / Qualification and budgets', '[[H2]] [[H30]]', 'Hub #2 delivered lifecycle contract v1, portable validators and shared fixtures in PR #74, with passing merged-main CI and a checksum-pinned release. Hub #30 early tooling is underway, but matched Windows/WSL evidence and frozen budgets remain incomplete and gate core implementation. Documented provider support does not prove installed-client compatibility.'],
             ['02 / Shared state and contracts', '[[H3]] [[P29]]', 'Pixoo #29 delivered adoption of the released lifecycle schema, fixtures and consumer requirements in PR #53. Hub #3 still owns the shared runtime state interpretation after the early budget gate.'],
    ...
    dict(id='nanoleaf-presentation', short='Rendering + displays', title='Improve Nanoleaf rendering, customization, and persistent displays', phase='Independent experience',
         ...
         headers=['Group', 'Issues and order', 'Dependency or boundary'], rows=[
             ...
             ['Prism crystal artwork', '[[N52]] → [[N53]] → [[N26]]', 'Connector geometry and crystal artwork merged in Nanoleaf PRs #56 and #58, each with all nine main jobs passing. The user approved the integrated Prism UI. Luminous numbering merged in PR #60 with all nine PR and main jobs passing. The full browser suite passed all 360 click cases and 720 label-clearance measurements after a mode-observation timing correction. All three issues remain open only for guide synchronization. Tray artwork and physical-light animation changes are excluded.'],
    ...
    dict(id='hosting-migrations', short='Hosting + migrations', title='Prepare always-on hosting and deliberate migrations', phase='Separate migration tracks',
         ...
         headers=['Group', 'Issues', 'Sequence or boundary'], rows=[
             ...
             ['Nanoleaf Linux installation', '[[N54]] → [[N55]] → [[H43]]', 'Prepare a fresh Linux installation reusing the current services and wall UI, then perform separately authorized installed acceptance. Existing Nanoleaf state can be left unused; preserve unrelated data and one light writer. After installed acceptance #55, reconcile the architecture documentation in Hub #43. Prism artwork can progress independently.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ['Bound CI costs and hangs', 'Completed [[N37]] and [[P46]]', 'Pixoo #46 merged through PR #57 with all five PR and main checks passing. Nanoleaf #37 completed after PR #61 and guide companion PR #90 merged with all required main checks passing. The original sequence limited CI churn; it was not a product dependency.'],
             ['Hub CI efficiency', '[[H91]]', 'PRs #92 and #93 merged core scheduling, build-once commands and Python download caching. Both core changes passed all twelve PR and main jobs. Measurement and guide scheduling completion remain with the Hub #91 coordinator; the issue is still open.'],
