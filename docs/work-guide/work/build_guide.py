...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['03 / First host and controller API', '[[P31]] [[P37]]', 'Embed shared state in Pixoo and expose its existing controller to the hub. Pixoo #37 is in progress, independently of the state implementation. Its candidate adds the protected shared controller API through the existing writer; source acceptance remains pending.'],
