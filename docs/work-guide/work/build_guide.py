...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['03 / First host and controller API', '[[P31]] [[P37]]', 'Pixoo #31 is in progress: consume released agent-state 1.0.0 through private durable storage and a selected embedded/remote source. Local performance measurements exceed the fixed Linux budgets, so source acceptance and merge are blocked. Pixoo #37 can proceed independently.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ['BUNNY system design documents', 'Completed [[H103]]', 'The separately owned issue is closed after PR #104 merged the HTML atlas, offline Scalar references for 37 explicit HTTP operations and SchemaSpy reports for 28 source-defined tables. Its acceptance receipt remains authoritative. Browser request controls remain disabled pending integration with each owning service; this guide update makes no runtime or device claim.'],
