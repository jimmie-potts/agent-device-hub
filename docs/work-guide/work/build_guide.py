...
GUIDES = [
    ...
    dict(id='desktop-controls', short='Desktop controls', title='Add Codex mouse actions and later desk presets', phase='Independent shortcuts, then shared presets',
         intro='[[H63]] is closed after documentation PR #140 merged. [[H64]] is in review and still blocked; its open PR does not establish acceptance. The other seven issues retain their own prerequisites. <strong>Codex mouse controls can ship without the hub, shared monitoring, general controls or Music.</strong> Keyboard A/B and the attached Super Buttons are programmed directly on the keyboard, outside B.U.N.N.Y.',
         headers=['Work', 'Owning issue', 'Required prerequisites and result'], rows=[
             ...
             ['N30 mouse qualification', '[[H64]]', 'Qualification is under review in Hub PR #143. The owner identified keyboard 85HA and N30 mouse 85CA, observed four distinct N30 browser outputs and an A Enter press/release. B produced a complete Ctrl+Win hold/release after the observer repeat cutoff was corrected. The owner passed the brief Wispr/Notepad trial and cleared both mappings. The completed A/B trial is historical personal setup evidence. Receiver identity, mouse recovery and selective Codex handling remain unresolved; no A/B integration gate remains. Read the qualification report for evidence limits.'],
             ['Independent / Local controls', '[[H65]]', 'Requires [[H63]] and successful [[H64]] qualification. Codex mouse actions: next task needing attention, command menu, previous task and next task. Preserve ordinary mouse behavior outside Codex. Keyboard A/B and attached Super Buttons are excluded from configuration, dispatch and preset bindings.'],
