...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['Current status and separate follow-ups', '[[H137]] [[H138]] [[H139]]', 'Hub #137 is in progress for best-effort status across successive Codex turns. Per-task recovery #138 depends on its accepted status rules. Reliable event history #139 remains deferred and requires refinement; neither follow-up blocks the current-status fix. These issues are included by the refreshed backlog, not delivered by desktop-input qualification.'],
