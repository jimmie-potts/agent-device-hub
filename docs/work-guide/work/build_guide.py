...
GUIDES = [
    ...
    dict(id='desktop-controls', short='Desktop controls', title='Add Codex mouse actions and later desk presets', phase='Independent shortcuts, then shared presets',
         ...
         headers=['Work', 'Owning issue', 'Required prerequisites and result'], rows=[
             ...
             ['N30 mouse qualification', '[[H64]]', 'Qualification is under review in Hub PR #143. The owner identified keyboard 85HA and N30 mouse 85CA, observed four distinct N30 browser outputs and an A Enter press/release. B produced a complete Ctrl+Win hold/release after the observer repeat cutoff was corrected. The owner passed the brief Wispr/Notepad trial and cleared both mappings. The completed A/B trial is historical personal setup evidence. A receiver comparison associates N30 with 062A:4101, and Windows reports Codex package 26.917.6896.0; mouse operation returned after reconnect. Native D-pad attribution, recovery and selective Codex handling remain unresolved; no A/B integration gate remains. Read the qualification report for evidence limits.'],
