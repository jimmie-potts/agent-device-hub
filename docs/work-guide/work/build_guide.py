...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['03 / First host and controller API', '[[P31]] [[P37]]', 'Pixoo #31 is in progress: consume released agent-state 1.0.0 through private durable storage and a selected embedded/remote source. Source review, performance acceptance and merge remain pending. Pixoo #37 can proceed independently.'],
