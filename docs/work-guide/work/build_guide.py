...
GUIDES = [
    ...
    dict(id='nanoleaf-devices', short='Lines + Light Panels', title='Add Nanoleaf Light Panels alongside Lines', phase='Independent feature',
         ...
         headers=['Order', 'Issue', 'Result'], rows=[
             ...
             ['Completed / Runtime worker source', '[[N42]]', 'The runtime-worker issue is closed in this snapshot. Device effects, installation and physical acceptance retain their own issues.'],
    ...
    dict(id='tidbyt-lifx', short='Tidbyt + LIFX', title='Add automatic status to Tidbyt and LIFX', phase='Additional devices',
         ...
         headers=['Track', 'Issue sequence', 'Work and dependencies'], rows=[
             ['Tidbyt cloud', '[[H15]] → [[H16]] → [[H19]] → [[H21]]', 'Connection qualification #15 is closed in this snapshot. Controller source, automatic status and installed acceptance remain separate.'],
    ...
    dict(id='desktop-controls', short='Desktop controls', title='Add Codex mouse actions and later desk presets', phase='Independent shortcuts, then shared presets',
         ...
         headers=['Work', 'Owning issue', 'Required prerequisites and result'], rows=[
             ...
             ['N30 mouse qualification', '[[H64]]', 'The owner passed the brief Windows AutoHotkey trial: all four Codex actions, normal navigation outside Codex and restoration after stopping. The accepted personal route shares PageUp/PageDown/Back/Forward with other input devices while Codex is active. N30 85CA uses receiver 062A:4101; the reported Codex package is 26.917.6896.0. Per-device isolation and long-term recovery remain unqualified. The completed A/B trial is historical personal setup; those controls are outside B.U.N.N.Y. Source review remains in PR #143.'],
             ['Independent / Local controls', '[[H65]]', 'Requires [[H63]] and successful [[H64]] qualification. Codex mouse actions: next task needing attention, command menu, previous task and next task. Preserve ordinary mouse behavior outside Codex and disclose shared-key behavior inside it. Keyboard A/B and attached Super Buttons are excluded from configuration, dispatch and preset bindings.'],
    ...
    dict(id='development-workflow', short='Development workflow', title='Reduce development overhead and consolidate shared tooling', phase='Maintenance',
         ...
         headers=['Group', 'Issues', 'Order'], rows=[
             ...
             ['Atlas and diagram readability', '[[H172]] → [[H173]]', 'First establish the system map and lifecycle walkthrough; then apply its accepted pattern to the remaining guide diagrams. These are separate planned documentation deliveries.'],
             ['Nanoleaf guide-maintenance rules', '[[N70]]', 'Align its delivery instructions with the Hub procedure: guide updates are intentional revisions; no per-delivery ledger or automatic companion PR.'],
