...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['04 / Consumers and integration controls', '[[P32]] [[P33]] [[N49]]', 'Pixoo dashboard [[P32]] is in source review through PR #63: exact RGB preview, stable pagination and bounded generation publication. Monitor/Media controls and protected settings/assignments retain their own work.'],
