...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['Parallel / Pixoo display qualification', '[[P30]]', 'Pixoo #30 source qualification is in progress: an offline-default bounded frame runner, exact RGB payload previews and shared local writer exclusion. Text/item execution remains unavailable because exact device-font preview is unqualified. Physical latency, interruptions, recovery and the measured method/cadence decision remain pending before #33 device integration. Pure rendering and simulator work can proceed earlier.'],
