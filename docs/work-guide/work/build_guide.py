...
GUIDES = [
    ...
    dict(id='hosting-migrations', short='Hosting + migrations', title='Prepare always-on hosting and deliberate migrations', phase='Separate migration tracks',
         ...
         headers=['Group', 'Issues', 'Sequence or boundary'], rows=[
             ...
             ['Fresh Nanoleaf Linux runtime', '[[N54]] → [[N55]]', 'Implement a fresh Linux installation, then perform separately authorized WSL installation and acceptance. This does not migrate the existing Windows state. Preserve one light writer; stop existing Windows services before Linux ownership begins.'],
