...
GUIDES = [
    ...
    dict(id='shared-codex', short='Shared Codex integration', title='Deliver shared Codex monitoring and integration controls', phase='Main development path',
         ...
         headers=['Stage', 'Owning issues', 'Result'], rows=[
             ...
             ['04 / Consumers and integration controls', '[[P33]]', 'Pixoo dashboard [[P32]] is delivered through PR #63: exact RGB preview, stable pagination and bounded generation publication. Monitor/Media controls and protected settings/assignments retain their own work.'],
             ...
             ['05 / Shared hosting and clients', '[[H5]] [[H8]] [[H6]] [[H13]]', 'Hub #5 now targets Linux in WSL; native Windows runtime qualification is outside its accepted scope. Its standalone host candidate is in progress, with final Pixoo settings integration awaiting [[P33]]. Source delivery, reversible hook migration [[H8]], the common frontend and shared MCP discovery/status remain separate gates.'],
