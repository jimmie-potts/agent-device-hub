...
D2 = arch(
    ...
    cards=[
        ...
        {'dot': 'emerald', 'title': 'Ownership', 'items': ['Each physical device has one designated writer and private state', 'Embedded Pixoo hosting is delivered; new controllers remain planned']},
    ],
...
D3 = seq(
    ...
    cards=[
        {'dot': 'violet', 'title': 'Evidence and hosting', 'items': ['Activity, attention, notices and read evidence stay separate; five minutes without evidence means uncertain.', 'Pixoo #31 hosts agent-state 1.0 with private durable storage. Device presentation remains planned.']},
    ],
    views=[
...
DIAGRAMS = [
    ...
    dict(id='arch-shared-system', spec=D2, kind='architecture', status='planned',
         status_label='Embedded host source delivered; consumers pending', short='Shared system and ownership',
         ...
         boundaries=['Released [[H3]] supplies the shared engine. [[P31]] embeds one private durable owner and authenticated bounded feeds. Standalone hosting [[H5]], device-feed adoption and numeric qualification [[P61]] remain pending.',
    ...
    dict(id='seq-lifecycle-observation', spec=D3, kind='sequence', status='planned',
         status_label='Embedded source API delivered; presentation integration pending', short='Lifecycle observation',
         ...
         boundaries=['Activity, attention, notices, acknowledgment, optional provider read evidence and freshness stay distinct. Turn end proves neither success nor readership.',
                     'Lifecycle 1.0 defines the envelope; released [[H3]] supplies versioned snapshots, bounded revision notifications and consumer-scoped acknowledgment. [[P31]] implements the authenticated endpoint and durable storage adapter; [[P61]] owns deferred numeric qualification.'],
         sources=[(H, 'docs/architecture.md'), (H, 'packages/agent-state/README.md'), (H, 'docs/controller-contract.md'), (P, 'docs/hub-integration.md'), (P, 'docs/agent-monitoring.md'), (N, 'docs/hub-integration.md')],
    ...
    dict(id='seq-owner-migration', spec=D8, kind='sequence', status='future',
         ...
         sources=[(H, 'docs/architecture.md'), (H, 'packages/agent-state/README.md'), (P, 'docs/hub-integration.md'), (P, 'docs/agent-monitoring.md'), (N, 'docs/hub-integration.md')],
