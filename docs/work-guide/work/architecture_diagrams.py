...
D2 = arch(
    ...
    components=[
        ...
        c2('nanoleaf', 'backend', 'Nanoleaf controller', 'Python · Work/Quiet/Free', 1, 1, 'source candidate'),
...
DIAGRAMS = [
    ...
    dict(id='seq-lifecycle-observation', spec=D3, kind='sequence', status='planned',
         status_label='Embedded source API delivered; Nanoleaf candidate under review', short='Lifecycle observation',
