...
DIAGRAMS = [
    ...
    dict(id='arch-shared-system', spec=D2, kind='architecture', status='planned',
         status_label='Linux host source delivered; other clients remain planned', short='Shared system and ownership',
    ...
    dict(id='seq-owner-migration', spec=D8, kind='sequence', status='implemented',
         status_label='Source migration delivered; installed cutover pending', short='Owner migration',
