...
TRACKS = [
    ...
    ('Development workflow', [
        dict(id='n-dev-ci', x=0, label='CI + guide maintenance', issues=['N37', 'H73', 'H80'], guide='development-workflow'),
        dict(id='n-dev-jobs', x=1, label='Job consolidation', issues=['P47', 'H91'], guide='development-workflow'),
