...
TOPICS = [
    ...
    ('hosting-migrations', 'Hosting and migrations',
     ...
     'Run the installed Pixoo app as a user service so BUNNY controls and agent status survive restarts. Other hosting and repository migrations remain later choices; select one target and preserve explicit ownership and private state boundaries.', ['P77']),
