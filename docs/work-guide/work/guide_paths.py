...
TOPICS = [
    ...
    ('work-guide', 'Work guide and system atlas',
     ...
     'The Neon restyle, mobile publication, circuit trace, starting-session recommendations, story-owned topic placement and the Ideas section are delivered. The atlas playback prose now reflects the installed Sony and Sonos sources; its baseline pins remain dated. A shared Places navigation is in progress under H278; Nanoleaf N189 owns the wall map return link. Next: finish and review the Hub navigation, then reconcile story text made stale by recent deliveries and continue the nightly guide refresh. Mission-map navigation, signal playback and the trading-card skin keep blocked labels.', ['H278', 'N189', 'H311', 'H341', 'H315', 'H316']),
