...
TOPICS = [
    ...
    ('assistant-access', 'Automation and remote access',
     ...
     'Hub moments are decided (ADR 0006), and controller contract 1.1 carries the moment command. Next: store event rules and the interrupt set and arbitrate the moments they trigger, send moments through contract 1.1, and keep the hub starting as its MCP tool catalog grows. Scheduled routines and Automation widgets follow. The conversational assistant, phone access, remote Pixoo control and native-app handoffs stay deferred; qualify a supported path before implementing its dependent stages.', ['H358', 'H335', 'H357', 'H45']),
