...
def refresh_repo(repo):
    ...
    targets = {'agent-device-hub': [2, 5, 30, 31, 32, 43, 50, 63, 83, 91, 148], 'codex-nanoleaf': [26, 29, 30, 34, 37, 41, 49, 52, 53, 54, 55, 64], 'divoom-app-upgrade': [12, 26, 29, 30, 31, 32, 33, 34, 37, 46]}[repo]
    direct = []
    for number in targets:
        ...
        references_only = (repo == 'codex-nanoleaf' and number in (30, 41, 54, 55, 64)) or (repo == 'divoom-app-upgrade' and number in (30, 34))
