...
def refresh_repo(repo):
    ...
    targets = {'agent-device-hub': [2, 5, 15, 16, 30, 31, 32, 43, 50, 63, 64, 83, 91, 148, 151, 153, 158, 172, 173, 179, 185], 'codex-nanoleaf': [21, 26, 29, 30, 34, 37, 41, 42, 43, 49, 52, 53, 54, 55, 64, 70, 72], 'divoom-app-upgrade': [12, 26, 29, 30, 31, 32, 33, 34, 37, 46]}[repo]
    direct = []
