...
def build(check=False):
    ...
    page = f'''<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>API &amp; database reference · BUNNY</title><meta name="description" content="Explore BUNNY's existing device service endpoints and SQLite schemas, from pinned source code."><style>{css}</style></head>
<body><a class="skip" href="#main">Skip to reference</a><header class="top"><a class="brand" href="../index.html">B/ <span>BUNNY</span></a><nav aria-label="Reference navigation"><a href="../full-system-design.html">System design</a><a href="#apis">Endpoints</a><a href="#databases">Tables</a></nav></header>
...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{html.escape(name)} API · BUNNY</title><meta http-equiv="Content-Security-Policy" content="connect-src 'none'; font-src 'self' data:; img-src 'self' data: blob:;"><style>body{{margin:0;background:#101820;color:#edf4f4;font:15px/1.5 system-ui,sans-serif}}.reference-header{{padding:14px 24px;border-bottom:1px solid #384b4b;display:flex;flex-wrap:wrap;gap:8px 24px;align-items:center}}.reference-header a{{color:#9cf1d5}}.reference-header small{{color:#c1cccd}}a:focus-visible{{outline:2px solid #9cf1d5;outline-offset:4px}}</style></head><body><header class="reference-header"><a href="../index.html">← BUNNY reference</a><strong>{html.escape(name)}</strong><small>Offline reference · browser requests disabled · port 0 is a placeholder</small><a href="../openapi/{slug}.json" download>Download OpenAPI</a></header><main id="app"></main><script src="../assets/scalar-1.69.2.js"></script><script>Scalar.createApiReference('#app', {serialized});</script></body></html>
'''
