...
- Generate Codex hooks.json or Claude settings.json entries, keeping unrelated top-level settings. Windows Codex clients receive an explicit wsl.exe argument construction for the declared distribution and Linux executable; this is source-tested construction, not native installation qualification.
